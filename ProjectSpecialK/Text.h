...
extern TextEntry& TextAdd(const std::string& key, JSONObject& map);
//Adds a presumably English string to the string database.
extern TextEntry& TextAdd(const std::string& key, const std::string& english);
...
extern TextEntry& TextAdd(const std::string& key, JSONValue& value);
//Adds a presumably English string to the string database.
...
extern std::string TextGet(const std::string& key, Language lang = Language::Default);
//Returns a localized string.
