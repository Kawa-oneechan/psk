...
//Returns a JSON array initialized from a vec2.
extern jsonValue GetJSONVec(const glm::vec2& vec);
//Returns a JSON array initialized from a vec2, its values cast to int.
extern jsonValue GetJSONVecI(const glm::vec2& vec);
//Returns a JSON array initialized from a vec3.
extern jsonValue GetJSONVec(const glm::vec3& vec);
//Returns a JSON array initialized from a vec3, its values cast to int.
extern jsonValue GetJSONVecI(const glm::vec3& vec);
//Returns a JSON array initialized from a vec4.
extern jsonValue GetJSONVec(const glm::vec4& vec);
