...
private:
	...
	glm::vec4 textRenderColor{ 0,0,0,1 }, originalTextRenderColor{ 0,0,0,1 };
	float textRenderSize{ 100 }, originalTextRenderSize{ 100 };
	int textRenderFont{ 0 }, originalTextRenderFont{ 0 };
