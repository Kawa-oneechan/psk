 ...
 * \param height Vertical size in pixels of the source bitmap.
 */
void scalebit(unsigned scale, void* void_dst, unsigned dst_slice, const void* void_src, unsigned src_slice, unsigned pixel, unsigned width, unsigned height, unsigned opt)
{
	switch (scale) {
	case 202 :
	case 2 :
